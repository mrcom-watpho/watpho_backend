...
$db = new DB();
$sql = " SELECT * FROM tb_work_type WHERE id = '".$_GET['id']."' ";
$db->Execute($sql);
$family = $db->getData();
?>
<!-- begin breadcrumb -->
...
<div class="panel panel-inverse">
    ...
    <div class="panel-body">
        ...
        <input type="hidden" id="Id_workEdit" name="Id_workEdit" class="form-control" value="<?php echo $family['id'];?>" />

                              <div class="form-group row">
									<label class="col-lg-4 col-form-label">ประเภทการทำงาน</label>
									<div class="col-lg-8">
										<div class="input-group date">
											<input type="text" id="work_type_name" name="work_type_name" value="<?php echo $family['work_name'];?>" class="form-control" required />
