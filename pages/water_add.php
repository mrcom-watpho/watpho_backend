                             ...
                             <div class="form-group row">
									...
									<div class="col-lg-8">
										<div class="input-group date">
											<input type="text" id="water_id" name="water_id" class="form-control" required />
                              ...
                              <div class="form-group row">
									...
									<div class="col-lg-8">
										<div class="input-group date">
											<input type="text" id="water_name" name="water_name" class="form-control" required />
											<div class="input-group-addon">
												<i class="fa fa-file"></i>
											</div>
										</div>
                                ...
                                <div class="form-group row">
									...
									<div class="col-lg-8">
										<div class="input-group date">
											<input type="text" id="water_location" name="water_location" class="form-control" required />
											<div class="input-group-addon">
												<i class="fa fa-file"></i>
											</div>
										</div>
