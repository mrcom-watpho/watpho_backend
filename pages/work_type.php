<ol class="breadcrumb float-xl-right">
    <li class="breadcrumb-item"><a href="javascript:;">ประเภทปฏิบัติงาน</a></li>
    <li class="breadcrumb-item"><a href="javascript:;">Work Type</a></li>
</ol>

<h1 class="page-header">Work Type<small>ประเภทปฏิบัติงาน</small></h1>
<a href="main.php?t=setting&page=work_type_add" class="btn btn-info"><i class="fa fa-edit"></i> เพิ่มข้อมูล</a>
<hr>
<div class="panel panel-inverse">
    <div class="panel-heading">
        <h4 class="panel-title">ประเภทปฏิบัติงาน</h4>
    ...
    <div class="panel-body">
        <table id="dgv-table" class="table table-striped table-bordered table-td-valign-middle">
            ...
            <tbody>
                <?php
                    $db_category = new DB();
                    $sql_category = " SELECT * FROM tb_work_type ORDER BY id asc  ";
                ...
                <tr>
                    ...
                    <td><?php echo $i;?></td>
                    <td><?php echo $data_category['work_name'];?></td>
                    <td><a href="main.php?t=setup&page=work_type_edit&id=<?php echo $gen_id;?>" 
                            class="btn btn-yellow"><i class="fa fa-edit"></i>แก้ไข</a></td>
                     <td>   <a href="main.php?t=setup&page=work_type_delete&id=<?php echo $gen_id;?>" onclick="return confirm('Are you sure delete?')"
