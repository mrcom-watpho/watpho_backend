                             ...
                             <div class="form-group row">
									...
									<div class="col-lg-8">
										<div class="input-group date">
											<input type="text" id="post_station_id" name="post_station_id" class="form-control" required />
                              ...
                              <div class="form-group row">
									...
									<div class="col-lg-8">
										<div class="input-group date">
											<input type="text" id="post_station_ip" name="post_station_ip" class="form-control" required />
											<div class="input-group-addon">
												<i class="fa fa-file"></i>
											</div>
										</div>
                                ...
                                <div class="form-group row">
									...
									<div class="col-lg-8">
										<div class="input-group date">
											<input type="text" id="post_station_location" name="post_station_location" class="form-control" required />
											<div class="input-group-addon">
												<i class="fa fa-file"></i>
											</div>
										</div>
